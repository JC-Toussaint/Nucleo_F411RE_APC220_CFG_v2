...
//
///**
// * @brief  Writes single data.
// * @param  DeviceAddr: I2C address
// * @param  Reg: Register address
// * @param  Value: Data to be written
// * @retval None
// */
//void ssd1306_I2C_Write(uint16_t DeviceAddr, uint16_t Reg, uint8_t value)
//{
//	I2Cx_WriteMultiple(&hi2c1, DeviceAddr, (uint16_t)Reg, I2C_MEMADD_SIZE_8BIT,(uint8_t*)&value, 1);
//}
//
///**
...
// * @retval None
// */
//void ssd1306_I2C_WriteMultiple(uint16_t DeviceAddr, uint16_t Reg, uint8_t* data, uint16_t count)
//{
//	I2Cx_WriteMultiple(&hi2c1, DeviceAddr, (uint16_t)Reg, I2C_MEMADD_SIZE_8BIT,(uint8_t*)&data, count);
//}
///**
// * @brief  Reads single data.
// * @param  DeviceAddr: I2C address
// * @param  Reg: Register address
// * @retval Read data
// */
//uint8_t ssd1306_I2C_Read(uint16_t DeviceAddr, uint16_t Reg)
//{
//	uint8_t read_value = 0;
//	I2Cx_ReadMultiple(&hi2c1, DeviceAddr, Reg, I2C_MEMADD_SIZE_8BIT, (uint8_t*)&read_value, 1);
//	return read_value;
//}
